...
@section('content')
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title">{{ trans('messages.Edit Youtub Video') }}</h3>
            </div>
    ...
    <section class="content">
        {!! Form::open([
            'method' => 'PUT',
            'route' => ['youtubVideos.update', $youtubeVideosController->id],
            'files' => true,
            'id' => 'edit-youtubVideos-form',
        ]) !!}
        <div class="row">
                ...
                <div class="box">
                    <div class="box-body">
                            ...
                            <div class="tab-pane active" id="home7" role="tabpanel">
                                <div class="p-15">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::text('title_ar', $youtubeVideosController->title_ar, [
                                                'id' => 'title_ar',
                                                'class' => 'form-control',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::textarea('description_ar', $youtubeVideosController->description_ar, [
                                                'class' => 'form-control',
                            ...
                            <div class="tab-pane" id="home8" role="tabpanel">
                                <div class="p-15">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::text('title_en', $youtubeVideosController->title_en, [
                                                'id' => 'title_en',
                                                'class' => 'form-control',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::textarea('description_en', $youtubeVideosController->description_en, [
                                                'class' => 'form-control',
                            ...
                            <div class="tab-pane" id="profile7" role="tabpanel">
                                <div class="p-15">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::text('title_nl', $youtubeVideosController->title_nl, [
                                                'id' => 'title_nl',
                                                'class' => 'form-control',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::textarea('description_nl', $youtubeVideosController->description_nl, [
                                                'class' => 'form-control',
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                {!! Form::select(
                                    ...
                                    $youtubeVideosController->video_type,
                                    [
                                        'class' => 'form-control',
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                {!! Form::text('video_link', $youtubeVideosController->video_link, [
                                    'id' => 'video_link',
                                    'class' => 'form-control',
                                ...
                                <div class="custom-file-container">
                                    ...
                                    <div class="bg-lightest p-10 rounded5 dvPreview text-center"
                                        ...
                                        <img style="max-width: 100%;height: 100%"
                                            src="{{ $youtubeVideosController->image ? url($youtubeVideosController->image) : url('/images/noimg.png') }}"
                                            alt="">
                                    </div>
                                </div>
                                @error('image')
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                {!! Form::checkbox('enabel', null, $youtubeVideosController->enabel, ['id' => 'Checkbox_1']) !!}
