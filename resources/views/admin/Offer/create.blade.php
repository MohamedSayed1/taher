<div class="modal-header">
    <h4 class="modal-title" id="">{{ trans('messages.Create Offer') }}</h4>
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
</div>
<div class="modal-body" style="margin: .2% !important;">
    {!! Form::open(['route' => 'offer.store', 'files' => true, 'id' => 'add-offer-form']) !!}
        ...
        <div class="tab-pane active" id="home7" role="tabpanel">
            <div class="p-15">
                <div class="form-group">
                    ...
                    <div>
                        {!! Form::text('title_ar', null, ['class' => 'form-control', 'placeholder' => trans('messages.Title Ar')]) !!}
                    </div>
                    @error('title_ar')
        ...
        <div class="tab-pane" id="home8" role="tabpanel">
            <div class="p-15">
                <div class="form-group">
                    ...
                    <div>
                        {!! Form::text('title_en', null, ['class' => 'form-control', 'placeholder' => trans('messages.Title EN')]) !!}
                    </div>
                    @error('title_en')
                        <div class="badge badge-danger text-center" style="width: 100%">
                            {{ $message }}
        ...
        <div class="tab-pane" id="profile7" role="tabpanel">
            <div class="p-15">
                <div class="form-group">
                    ...
                    <div>
                        {!! Form::text('title_nl', null, ['class' => 'form-control', 'placeholder' => trans('messages.Title Nl')]) !!}
                    </div>
                    @error('title_nl')
                        <div class="badge badge-danger text-center" style="width: 100%">
                            {{ $message }}
    ...
    <div class="form-group" style="padding: 1em;">
        ...
        <div>
            {!! Form::datetimeLocal('start_date', null, [
                'class' => 'form-control',
    ...
    <div class="form-group" style="padding: 1em;">
        ...
        <div>
            {!! Form::datetimeLocal('end_date', null, [
                'class' => 'form-control',
