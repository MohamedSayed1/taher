...
@section('content')
    ...
    <section class="content">
        {!! Form::open(['route' => 'theoryPackage.store', 'files' => true, 'id' => 'add-theoryPackage-form']) !!}
        <div class="row">
                            ...
                            <div class="tab-pane active" id="home7" role="tabpanel">
                                <div class="p-15">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::textarea('short_desc_ar', null, [
                                                'class' => 'form-control',
                            ...
                            <div class="tab-pane" id="home8" role="tabpanel">
                                <div class="p-15">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::textarea('short_desc_en', null, [
                                                'class' => 'form-control',
                            ...
                            <div class="tab-pane" id="profile7" role="tabpanel">
                                <div class="p-15">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            {!! Form::textarea('short_desc_nl', null, [
                                                'class' => 'form-control',
                                    ...
                                    <div class="custom-file-container">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label"
                                                   for="image">{{ trans('messages.photo_desktop') }}</label>
                                        </div>
