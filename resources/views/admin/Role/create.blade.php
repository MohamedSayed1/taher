...
@section('content')
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title">{{ trans('messages.Add Role') }}</h3>
            </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="box">
                    {!! Form::open(['route' => 'role.store', 'files' => true, 'id' => 'add-role-form']) !!}
                    <div class="box-body">
                        ...
                        @foreach (config('global.permissions') as $permgroup => $permissions)
                            <h3 class="text-center"
                                style="background-color: #7e8299;color: #fff;margin: 1.3em 0em;padding: 5px;">
                                {{ trans('messages.' . $permgroup) }}</h3>
                            <div class="perm-cont">
                                <div class="row">
                                    @foreach ($permissions as $key => $permission)
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="checkbox">
                                                    {!! Form::checkbox('permissions[]', $key, 0, ['id' => 'Checkbox_' . $key]) !!}
                                                    <label
