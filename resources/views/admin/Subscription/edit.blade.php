...
@section('content')
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title">{{ trans('messages.Edit Subscribtion') }}</h3>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('package_id', $packages, $subscription->package_id, [
                            ...
                            <div class="col-md">
                                <div class="form-group" id="offer_id_cont">
                                    ...
                                    <div>
                                        {!! Form::select('offer_id', $offers, $subscription->offer_id, [
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="form-group" style="padding: 1em;">
                                    ...
                                    <div>
                                        {!! Form::number('offer_discount', $subscription->offer_discount, [
                                            'class' => 'form-control',
                                            'id' => 'offer_discount',
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group" style="padding: 1em;">
                                    ...
                                    <div>
                                        {!! Form::datetimeLocal('subscription_date', $subscription->subscription_date, [
                                            'class' => 'form-control',
                            ...
                            <div class="col-md">
                                <div class="form-group" style="padding: 1em;">
                                    ...
                                    <div>
                                        {!! Form::datetimeLocal('expiration_date', $subscription->expiration_date, [
                                            'class' => 'form-control',
